...
<div class="container">
	<nav class="main-nav">
		<ul>
			...
			<?php if(is_admin()) { ?><li><a href="<?php echo esc_url(admin_url('post-new.php')); ?>" class="post-new-link icon">&#59396;</a></li><?php } ?>
			<?php if(is_admin()) { ?><li><a href="#projects" class="projects"><?php _e('@', 'capsule'); ?></a></li><?php } ?>
...
?>
			<?php if(is_admin()) { ?><li><a href="<?php echo esc_url(admin_url('admin.php?page=capsule')); ?>" class="icon">&#59400;</a></li><?php } ?>
