...
printf(__('<a href="%1$s">%2$s</a>', 'capsule'), esc_url(get_author_posts_url($post->post_author)), get_the_author_meta('display_name'));
...
?>
	...
	<div class="post-content">
		...
		<nav class="post-menu">
			...
			<?php if(is_admin()) { edit_post_link('&#57535;', '', ''); } ?>
			<?php if(is_admin()) { ?><a href="#" class="post-delete-link" title="<?php _e('Trash', 'capsule'); ?>">&#59177;</a><?php } ?>
